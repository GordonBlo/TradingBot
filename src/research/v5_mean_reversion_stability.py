...
def evaluate_v5_h0_gate(
    *,
    metrics: V5H0Metrics,
    window_net_expectancies_r: tuple[Decimal, ...],
) -> V5H0GateResult:
    """Apply the preregistered V5-H0 gate without extra thresholds."""
