...
def evaluate_v4_h0_gate(
    *,
    metrics: V4H0Metrics,
    window_net_expectancies_r: tuple[Decimal, ...],
) -> V4H0GateResult:
    """Apply the preregistered V4-H0 gate without extra thresholds."""
    ...
    return V4H0GateResult(
        ...
        positive_net_window_ratio_passed=positive_net_window_ratio_passed,
    )
